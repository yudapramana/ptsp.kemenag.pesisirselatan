...
<div class="container-fluid">
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1 class="m-0 text-dark">Ubah Data Layanan</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
...
<div class="row">
  <div class="col-sm-12">
    ...
    <div class="card card-default">
      {{ Form::open(['url'=>'data_layanan/ubah/'.Helper::encrypt($data->id), 'method'=>'post', 'class'=>'form-horizontal']) }}
      <!-- end card-header -->
      ...
      <div class="card-body">
          <div class="form-group {{ $errors->has('id_unit_pengolah') ? 'has-error' : '' }}">
            ...
            <div class="col-sm-12">
              {{ Form::select('id_unit_pengolah',Helper::get_unit_pengolah_arr(),$data->id_unit_pengolah,['class'=>'form-control']) }}
          ...
          <div class="form-group {{ $errors->has('id_jenis_layanan') ? 'has-error' : '' }}">
            ...
            <div class="col-sm-12">
              {{ Form::select('id_jenis_layanan',Helper::get_jenis_layanan_arr(),$data->id_jenis_layanan,['class'=>'form-control']) }}
          ...
          <div class="form-group {{ $errors->has('nama_layanan') ? 'has-error' : '' }}">
            ...
            <div class="col-sm-12">
              {{ Form::text('nama_layanan',$data->nama_layanan,['class'=>'form-control']) }}
          ...
          <div class="form-group {{ $errors->has('id_output') ? 'has-error' : '' }}">
            ...
            <div class="col-sm-12">
              {{ Form::select('id_output',Helper::get_output_arr(),$data->id_output,['class'=>'form-control']) }}
          ...
          <div class="form-group {{ $errors->has('lama_layanan') ? 'has-error' : '' }}">
            ...
            <div class="col-sm-12">
              {{ Form::text('lama_layanan',$data->lama_layanan,['class'=>'form-control']) }}
          ...
          <div class="form-group {{ $errors->has('biaya') ? 'has-error' : '' }}">
            ...
            <div class="col-sm-12">
              {{ Form::text('biaya',$data->biaya,['class'=>'form-control']) }}

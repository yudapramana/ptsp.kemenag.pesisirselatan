...
<div class="container-fluid">
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1 class="m-0 text-dark">Ubah Pelayanan</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
...
<div class="row">
  <div class="col-sm-12">
    ...
    <div class="card card-default">
      {{ Form::open(['url'=>'pelayanan/ubah/'.Helper::encrypt($data->id), 'method'=>'post', 'class'=>'form-horizontal','files'=>true]) }}
      <!-- end card-header -->
      ...
      <div class="card-body">
          <div class="form-group {{ $errors->has('id_data_layanan') ? 'has-error' : '' }}">
            ...
            <div class="col-sm-12">
              {{ Form::select('id_data_layanan',Helper::get_data_layanan_arr(),$data->id_data_layanan,['class'=>'form-control', 'placeholder'=>'-- Nama layanan --','disabled']) }}
          ...
          <div class="form-group {{ $errors->has('perihal') ? 'has-error' : '' }}">
            ...
            <div class="col-sm-12">
              {{ Form::text('perihal',$data->perihal,['class'=>'form-control']) }}
          ...
          <div class="form-group {{ $errors->has('no_surat_pemohon') ? 'has-error' : '' }}">
            ...
            <div class="col-sm-12">
              {{ Form::text('no_surat_pemohon',$data->no_surat_pemohon,['class'=>'form-control']) }}
          ...
          <div class="form-group {{ $errors->has('tgl_surat_pemohon') ? 'has-error' : '' }}">
            ...
            <div class="col-sm-12">
              {{ Form::text('tgl_surat_pemohon',$data->tgl_surat_pemohon,['class'=>'form-control data-tanggal']) }}
          ...
          <div class="form-group {{ $errors->has('nama_pemohon') ? 'has-error' : '' }}">
            ...
            <div class="col-sm-12">
              {{ Form::text('nama_pemohon',$data->nama_pemohon,['class'=>'form-control']) }}
          ...
          <div class="form-group {{ $errors->has('alamat_pemohon') ? 'has-error' : '' }}">
            ...
            <div class="col-sm-12">
              {{ Form::text('alamat_pemohon',$data->alamat_pemohon,['class'=>'form-control']) }}
          ...
          <div class="form-group {{ $errors->has('nama_pengirim') ? 'has-error' : '' }}">
            ...
            <div class="col-sm-12">
              {{ Form::text('nama_pengirim',$data->nama_pengirim,['class'=>'form-control']) }}
          ...
          <div class="form-group {{ $errors->has('no_telp_pemohon') ? 'has-error' : '' }}">
            ...
            <div class="col-sm-12">
              {{ Form::text('no_telp_pemohon',$data->no_telp_pemohon,['class'=>'form-control']) }}
          ...
          <div class="form-group {{ $errors->has('kelengkapan_syarat') ? 'has-error' : '' }}">
            ...
            <div class="col-sm-12">
              {{ Form::select('kelengkapan_syarat',['Lengkap'=>'Lengkap','Belum Lengkap'=>'Belum Lengkap'],$data->kelengkapan_syarat,['class'=>'form-control','placeholder'=>'-- Kelengkapan syarat --']) }}
          ...
          <div class="form-group {{ $errors->has('status_layanan') ? 'has-error' : '' }}">
            ...
            <div class="col-sm-12">
              {{ Form::select('status_layanan',['Proses'=>'Proses','Selesai'=>'Selesai','Diambil'=>'Diambil'],$data->status_layanan,['class'=>'form-control','placeholder'=>'-- Status Layanan --']) }}
          ...
          <div class="form-group {{ $errors->has('catatan') ? 'has-error' : '' }}">
            ...
            <div class="col-sm-12">
              {{ Form::textarea('catatan',$data->catatan,['class'=>'form-control','rows'=>'4']) }}
          ...
          <div class="form-pengambilan">
            <div class="form-group {{ $errors->has('no_surat_terbit') ? 'has-error' : '' }}">
              ...
              <div class="col-sm-12">
                {{ Form::text('no_surat_terbit',$data->no_surat_terbit,['class'=>'form-control']) }}
            ...
            <div class="form-group {{ $errors->has('tgl_surat_terbit') ? 'has-error' : '' }}">
              ...
              <div class="col-sm-12">
                {{ Form::text('tgl_surat_terbit',$data->tgl_surat_terbit,['class'=>'form-control data-tanggal']) }}
            ...
            <div class="form-group {{ $errors->has('nama_pengambil') ? 'has-error' : '' }}">
              ...
              <div class="col-sm-12">
                {{ Form::text('nama_pengambil',$data->nama_pengambil,['class'=>'form-control']) }}
...
<script>
    ...
    $.ajax({
      ...
      success: function (response) {
        ...
        $.each(data, function (index, value) { 
          ...
          if (value.lampiran == '') {
            html+= `<a href="#" class="btn btn-default disabled"><i class="fa fa-download"></i> File belum di upload</a>
                    <input type="hidden" class="form-control" name="id_data_syarat[]" value="`+value.id_data_syarat+`"></input>
                    `;
          }else{
            html+= `<a href="{{ url('berkas') }}/`+value.lampiran+`" class="btn btn-success"><i class="fa fa-download"></i> Download</a>
                    <input type="hidden" class="form-control" name="id_data_syarat[]" value="`+value.id_data_syarat+`"></input>
                    `;
          }

          html+= `<input type="hidden" class="form-control" name="id_syarat_layanan[]" value="`+value.id+`"></input>
  ...
  $('select[name=status_layanan]').on('change', function () {
    if ($(this).val() == "Diambil") {
      ...
      $('input[name=tgl_surat_terbit]').val('{{ $data->tgl_surat_terbit }}');
    }else{

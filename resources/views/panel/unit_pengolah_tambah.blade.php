...
<div class="container-fluid">
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1 class="m-0 text-dark">Tambah Unit Pengolah</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="{{ url('dashboard') }}">Dashboard</a></li>
                <li class="breadcrumb-item"><a href="{{ url('unit_pengolah') }}">Unit Pengolah</a></li>
                <li class="breadcrumb-item active">Tambah Unit Pengolah</li>
            </ol>
        </div><!-- /.col -->
    </div><!-- /.row -->
</div><!-- /.container-fluid -->
...
<div class="row">
  <div class="col-sm-12">
    ...
    <div class="card card-default">
      {{ Form::open(['url'=>'unit_pengolah/tambah', 'method'=>'post', 'class'=>'form-horizontal']) }}
      <!-- end card-header -->
      ...
      <div class="card-body">
          <div class="form-group {{ $errors->has('nama_unit_pengolah') ? 'has-error' : '' }}">
            ...
            <div class="col-sm-12">
              {{ Form::text('nama_unit_pengolah','',['class'=>'form-control']) }}

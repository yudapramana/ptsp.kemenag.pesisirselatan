...
<div class="container-fluid">
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1 class="m-0 text-dark">Tambah Jenis Layanan</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
...
<div class="row">
  <div class="col-sm-12">
    ...
    <div class="card card-default">
      {{ Form::open(['url'=>'jenis_layanan/tambah', 'method'=>'post', 'class'=>'form-horizontal']) }}
      <!-- end card-header -->
      ...
      <div class="card-body">
          <div class="form-group {{ $errors->has('jenis_layanan') ? 'has-error' : '' }}">
            ...
            <div class="col-sm-12">
              {{ Form::text('jenis_layanan','',['class'=>'form-control']) }}

...
<div class="container-fluid">
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1 class="m-0 text-dark">Pelayanan</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
  ...
  <div class="col-sm-12">
    ...
    <div class="card card-default">
      ...
      <div class="card-header text-right bg-teal">
        {{ Form::open(['url'=>'pelayanan', 'method'=>'post']) }}
        <div class="row">
          <div class="col-sm-4">
          ...
          <div class="col-sm-8">
            @if(isset($cari))
              <a href="{{ url('pelayanan') }}" class="btn btn-warning btn-sm"><i class="fa fa-refresh"></i> Reset</a>
            @endif
            @if(Helper::cek_level_akses('pelayanan')->t)
            <a href="{{ url('pelayanan/tambah') }}" class="btn btn-success btn-sm"><i class="fa fa-plus"></i> Tambah</a>
            @endif
          </div>
        </div>
        <!-- end row -->
...
@section('js')
  <script type="text/javascript">
    function open_modal(id) {
      $('.modal-message').modal();
      $('#submit_hapus').attr("href","{{url('pelayanan')}}/hapus/"+id);
    }
  </script>
@stop
...
<div class="container-fluid">
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1 class="m-0 text-dark">Tambah Output Layanan</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="{{ url('dashboard') }}">Dashboard</a></li>
                <li class="breadcrumb-item"><a href="{{ url('output_layanan') }}">Output Layanan</a></li>
                <li class="breadcrumb-item active">Tambah Output Layanan</li>
            </ol>
        </div><!-- /.col -->
    </div><!-- /.row -->
</div><!-- /.container-fluid -->
...
<div class="row">
  <div class="col-sm-12">
    ...
    <div class="card card-default">
      {{ Form::open(['url'=>'output_layanan/tambah', 'method'=>'post', 'class'=>'form-horizontal']) }}
      <!-- end card-header -->
      ...
      <div class="card-body">
          <div class="form-group {{ $errors->has('output') ? 'has-error' : '' }}">
            ...
            <div class="col-sm-12">
              {{ Form::text('output','',['class'=>'form-control']) }}

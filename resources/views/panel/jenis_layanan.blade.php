...
<div class="container-fluid">
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1 class="m-0 text-dark">Jenis Layanan</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
  ...
  <div class="col-sm-12">
    ...
    <div class="card card-default">
      ...
      <div class="card-header text-right bg-teal">
        {{ Form::open(['url'=>'jenis_layanan', 'method'=>'post']) }}
        <div class="row">
          <div class="col-sm-4">
          ...
          <div class="col-sm-8">
            @if(isset($cari))
              <a href="{{ url('jenis_layanan') }}" class="btn btn-warning btn-sm"><i class="fa fa-refresh"></i> Reset</a>
            @endif
            @if(Helper::cek_level_akses('jenis_layanan')->t)
            <a href="{{ url('jenis_layanan/tambah') }}" class="btn btn-success btn-sm"><i class="fa fa-plus"></i> Tambah</a>
            @endif
          </div>
        </div>
        <!-- end row -->
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="text-center">
                  @if(Helper::cek_level_akses('jenis_layanan')->u)
                  <a href="{{url('jenis_layanan/ubah')}}/{{Helper::encrypt($value->id)}}" class="btn btn-warning btn-sm btn-ubah"><i class="fa fa-fw fa-edit"></i></a>
                  @endif
                  @if(Helper::cek_level_akses('jenis_layanan')->h)
...
@section('js')
  <script type="text/javascript">
    function open_modal(id) {
      $('.modal-message').modal();
      $('#submit_hapus').attr("href","{{url('jenis_layanan')}}/hapus/"+id);
    }
